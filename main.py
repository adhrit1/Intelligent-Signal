...
dist_sensor_A = Label(window,text = "First Sensor(m)")
...
dist_sensor2_A = Label(window,text = "First Sensor(m)")
...
dist_sensor_B = Label(window,text = "Second Sensor(m)")
...
dist_sensor2_B = Label(window,text = "Second Sensor(m)")
...
dist_sensor_C = Label(window,text = "Third Sensor(m)")
...
dist_sensor2_C = Label(window,text = "Third Sensor(m)")
...
dist_sensor_D = Label(window,text = "Fourth Sensor(m)")
...
dist_sensor2_D = Label(window,text = "Fourth Sensor(m)")
...
dist_sensor_E = Label(window,text = "Fifth Sensor(m)")
...
dist_sensor2_E = Label(window,text = "Fifth Sensor(m)")
...
sound_sensor2_value = 900#random.randint(600,1000)
